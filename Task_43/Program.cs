...
double b1 = ReadNumberFromConsole();
Console.WriteLine("Введите координату k1: ");
double k1 = ReadNumberFromConsole();
Console.WriteLine("Введите координату b2: ");
double b2 = ReadNumberFromConsole();
Console.WriteLine("Введите координату k2: ");
double k2 = ReadNumberFromConsole();
